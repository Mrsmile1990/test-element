...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'test-element2/src/utils/date-util';
  import ElScrollbar from 'test-element2/packages/scrollbar';
  import RepeatClick from 'test-element2/src/directives/repeat-click';
