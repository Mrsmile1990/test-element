...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'test-element2/src/utils/date-util';
  import { hasClass } from 'test-element2/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'test-element2/src/utils/util';
