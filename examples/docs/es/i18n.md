...
import locale from 'test-element2/lib/locale/lang/en'
...
import lang from 'test-element2/lib/locale/lang/en'
import locale from 'test-element2/lib/locale'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/test-element2[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'test-element2/lib/locale/lang/en')
  ]
}
```
...
import enLocale from 'test-element2/lib/locale/lang/en'
import zhLocale from 'test-element2/lib/locale/lang/zh-CN'
...
import enLocale from 'test-element2/lib/locale/lang/en'
import zhLocale from 'test-element2/lib/locale/lang/zh-CN'
import ElementLocale from 'test-element2/lib/locale'
...
<script src="//unpkg.com/test-element2"></script>
<script src="//unpkg.com/test-element2/lib/umd/locale/en.js"></script>
...
<script src="//unpkg.com/test-element2"></script>
<script src="//unpkg.com/test-element2/lib/umd/locale/zh-CN.js"></script>
<script src="//unpkg.com/test-element2/lib/umd/locale/en.js"></script>
