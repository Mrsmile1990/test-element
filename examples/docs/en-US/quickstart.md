...
```javascript
import Vue from 'vue';
import ElementUI from 'test-element2';
import 'test-element2/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'test-element2';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'test-element2';
